  ...
  <div class="image-div">
    <div class="citat break">
      <div class="center">
        ...
        <img class="image-m" src="/twApp/public/images/ro.png" alt="RoSom" width="194px" height="91px">
      </div>
    </div>
    ...
    <div id="delogare"></div>
    <img class="logout" src="/twApp/public/images/logout.png" onclick="logOut()" alt="Logout"  width="48px" height="48px">
  </div>
</body>
